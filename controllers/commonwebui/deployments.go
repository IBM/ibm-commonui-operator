...
func (r *CommonWebUIReconciler) getDesiredDeployment(ctx context.Context, instance *operatorv1alpha1.CommonWebUI, adminHubOnZen bool, needToRequeue *bool) (*appsv1.Deployment, error) {
	...
	volumes = append(volumes, Log4jsVolume, ClusterCaVolume, UICertVolume, InternalTLSVolume)

	container := CommonContainer
	container.Image = image
	container.Name = DeploymentName
	container.Env[7].Value = instance.Spec.GlobalUIConfig.CloudPakVersion
	container.Env[8].Value = instance.Spec.GlobalUIConfig.DefaultAdminUser
	container.Env[10].Value = instance.Spec.GlobalUIConfig.DefaultAuth
	container.Env[11].Value = instance.Spec.GlobalUIConfig.EnterpriseLDAP
	container.Env[12].Value = instance.Spec.GlobalUIConfig.EnterpriseSAML
	container.Env[13].Value = instance.Spec.GlobalUIConfig.OSAuth
	container.Env[23].Value = instance.Spec.CommonWebUIConfig.LandingPage
...
func (r *CommonWebUIReconciler) reconcileDeployment(ctx context.Context, instance *operatorv1alpha1.CommonWebUI, adminHubOnZen bool, needToRequeue *bool) error {
	...
	desiredDeployment, err := r.getDesiredDeployment(ctx, instance, adminHubOnZen, needToRequeue)
	if err != nil {
		return err
	}

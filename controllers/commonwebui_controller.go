...
import (
	...
	res "github.com/ibm/ibm-commonui-operator/resources"
...
const commonwebuiCrType = "commonwebui_cr"
...
func (r *CommonWebUIReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	listOpts := []client.ListOption{
		...
		client.MatchingLabels(res.LabelsForSelector(res.DeploymentName, commonwebuiCrType, instance.Name)),
	}
...
func (r *CommonWebUIReconciler) reconcileConfigMaps(instance *operatorv1alpha1.CommonWebUI, needToRequeue *bool) error {
...
func (r *CommonWebUIReconciler) deploymentForUI(instance *operatorv1alpha1.CommonWebUI) (*appsv1.Deployment, error) {
	...
	selectorLabels := res.LabelsForSelector(res.DeploymentName, commonwebuiCrType, instance.Name)
	podLabels := res.LabelsForPodMetadata(res.DeploymentName, commonwebuiCrType, instance.Name)
...
func (r *CommonWebUIReconciler) serviceForUI(instance *operatorv1alpha1.CommonWebUI) (*corev1.Service, error) {
	...
	selectorLabels := res.LabelsForSelector(res.ServiceName, commonwebuiCrType, instance.Name)
...
// Check if the common web ui Ingresses already exist. If not, create a new one.
// This function was created to reduce the cyclomatic complexity :)
func (r *CommonWebUIReconciler) reconcileIngresses(instance *operatorv1alpha1.CommonWebUI, needToRequeue *bool) error {
...
func (r *CommonWebUIReconciler) handleCRD(instance *operatorv1alpha1.CommonWebUI, currentCRD *apiextv1beta.CustomResourceDefinition) (reconcile.Result, error) {
...
func (r *CommonWebUIReconciler) newNavconfgCRD() *apiextv1beta.CustomResourceDefinition {
...
func (r *CommonWebUIReconciler) reconcileCr(instance *operatorv1alpha1.CommonWebUI) error {
	reqLogger := log.WithValues("Instance.Namespace", instance.Namespace, "Instance.Name", instance.Name)
...
func (r *CommonWebUIReconciler) createCustomResource(unstruct unstructured.Unstructured, name, namespace string) error {
...
func (r *CommonWebUIReconciler) reconcileCertificates(instance *operatorv1alpha1.CommonWebUI, needToRequeue *bool) error {
...
func (r *CommonWebUIReconciler) deleteDaemonSet(instance *operatorv1alpha1.CommonWebUI) {
...
func (r *CommonWebUIReconciler) deleteCRs(instance *operatorv1alpha1.CommonWebUI) error {

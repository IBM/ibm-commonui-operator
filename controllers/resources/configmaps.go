...
func ReconcileZenCardsConfigMap(ctx context.Context, client client.Client, instance *operatorsv1alpha1.CommonWebUI, needToRequeue *bool) error {
	...
	err := client.Get(ctx, types.NamespacedName{Name: ZenCardsConfigMapName, Namespace: instance.Namespace}, cm)
	if err != nil {
		if errors.IsNotFound(err) {
...
func ReconcileExtensionsConfigMap(ctx context.Context, client client.Client, instance *operatorsv1alpha1.CommonWebUI, needToRequeue *bool) error {
	...
	err := client.Get(ctx, types.NamespacedName{Name: ExtensionsConfigMapName, Namespace: instance.Namespace}, cm)
	if err != nil {
		if errors.IsNotFound(err) {
			route := &routesv1.Route{}

			// Get the cp-console route and add it to the configmap
			err = client.Get(ctx, types.NamespacedName{Name: ConsoleRouteName, Namespace: instance.Namespace}, route)
			if err != nil {

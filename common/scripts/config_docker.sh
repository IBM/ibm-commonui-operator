...
DOCKER_REGISTRY_EDGE="hyc-cloud-private-edge-docker-local.artifactory.swg-devops.com"
...
${CONTAINER_CLI} login "${DOCKER_REGISTRY_EDGE}" -u "${DOCKER_USERNAME}" -p "${DOCKER_PASSWORD}"

...
func (in *CommonWebUIStatus) DeepCopyInto(out *CommonWebUIStatus) {
	*out = *in
	...
	if in.ReconcileTiming != nil {
		in, out := &in.ReconcileTiming, &out.ReconcileTiming
		*out = make([]ReconcileTimingEntry, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReconcileTimingEntry) DeepCopyInto(out *ReconcileTimingEntry) {
	*out = *in
	in.StartTime.DeepCopyInto(&out.StartTime)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReconcileTimingEntry.
func (in *ReconcileTimingEntry) DeepCopy() *ReconcileTimingEntry {
	if in == nil {
		return nil
	}
	out := new(ReconcileTimingEntry)
	in.DeepCopyInto(out)
	return out
}
